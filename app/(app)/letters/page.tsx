  ...
  return (
    <div className="max-w-lg mx-auto px-4">
      <div className="pt-12 pb-6">
        ...
        <h1 className="text-2xl font-bold text-[#1F2933]">Letters</h1>
      </div>
      ...
      {!loading && !error && letters.length === 0 && (
        <div className="text-center py-16">
          <div className="w-16 h-16 bg-[#8FA87A]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-[#8FA87A]/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
            </svg>
          </div>
          <p className="text-[#1F2933]/60 text-sm">No letters yet.</p>
          <p className="text-[#1F2933]/40 text-xs mt-1">Written messages will appear here.</p>
        </div>
      )}
